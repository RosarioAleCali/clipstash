...
pub mod catcher {
  ...
  #[catch(404)]
  fn page_not_found(req: &Request) -> Json<&'static str> {
    Json("404")
  }

  #[catch(401)]
  fn request_error(req: &Request) -> Json<&'static str> {
    Json("request error")
  }

  #[catch(400)]
  fn missing_api_key(req: &Request) -> Json<&'static str> {
    Json("missing api key")
  }

  pub fn catchers() -> Vec<Catcher> {
    catchers![default, internal_error, page_not_found, request_error, missing_api_key]
  }
}
